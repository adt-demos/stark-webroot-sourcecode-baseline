...
$templateSettings = Factory::getApplication()->getTemplate(true)->params;
...
if ($document->countModules('masthead') || !$this->print || $tmpl !== 'component') {
	...
	$masthead = LayoutHelper::render('joomla.content.masthead', array('params' => $this->params, 'title' => $this->escape($this->item->title), 'item' => $this->item, 'print' => $this->print, 'templateSettings' => $templateSettings, 'params' => $params, 'imageBg' => $imagesBg));
