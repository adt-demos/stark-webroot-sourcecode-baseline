...
<div id="acm-video-<?php echo $mod; ?>" class="acm-hero style-1" style="background: url(<?php echo $heroBg; ?>) no-repeat;">
  <a class="btn <?php echo $btnClass ? $btnClass : 'btn-play'; ?> <?php echo $btnAction ? 'html5'.$btnAction : ''; ?>" data-group="myvideo-<?php echo $mod; ?>" href="<?php echo trim($btnLink); ?>" title="">
    <?php if(trim($btnIcon)) : ?>
...
(function($){
  jQuery(document).ready(function($) {
    $("#acm-video-<?php echo $mod; ?> .html5lightbox").html5lightbox({
      ...
      jsfolder: "<?php echo Uri::base(true).'/templates/ja_stark/js/html5lightbox/' ?>"
    });
  });
})(jQuery);
</script>